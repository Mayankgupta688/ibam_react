        ...
        this.state = {
            menuStructure: {
                "topMenu": [
                    ...
                    { id: "financialInstitutionMenu", to: "/financialinstitution", tabName: "Financial Institutions", subMenu: [] },
                    { id: "internalEntitiesMenu", to: "/internalentities", tabName: "Internal Entities", subMenu: [] },
                    { id: "businessUnitMenu", to: "/businessunits", tabName: "Business Units", subMenu: [] },
                    { id: "authorityGroupMenu", to: "/authoritygroups", tabName: "Authority Groups", subMenu: [] },
                    { id: "peopleMenu", to: "/people", tabName: "People", subMenu: [] },
                    { id: "feeAnalysisMenu", to: "/feeanalysis", tabName: "Fee Analysis", subMenu: [] },
